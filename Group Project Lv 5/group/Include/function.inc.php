...
function createUser($conn, $Username, $Email, $Passowrd){
  $sql = "INSERT INTO kebabusers (usersEmail,	usersUsername, usersPassword) VALUES (?,?,?); ";
  ...
  mysqli_stmt_bind_param($stmt, "sssss", $Username, $scramblePassword, $Email);
  mysqli_stmt_execute($stmt);
  mysqli_stmt_close($stmt);
